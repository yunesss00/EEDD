#ifndef ALPHABET_SOUP_SOLVER_HPP
#define ALPHABET_SOUP_SOLVER_HPP
...
public:
    ...
    char cell(int row, int col) const
    {
        ...
        return this->row(row)[static_cast<size_t>(col)];
    }
 ...
 * @return a vector of pairs <word, cells_coordinates [row,col]>, one for each found word.
 */
...
#endif // ALPHABET_SOUP_SOLVER_HPP
